  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="error-page">
        <h2 class="headline text-danger"> <i class="fas fa-server"></i></h2>

        <div class="error-content">
          <h3><i class="fas fa-exclamation-triangle text-danger"></i> ¡Ups! Algo salió mal.</h3>

          <p>
            Por el momento <strong> No hay conexión con la base de datos</strong>, trabajaremos para solucionarlo de inmediato. Mientras tanto, puedes volver dando click en el siguiente botón.
          </p>
